...
class MiniProject2 {
	...
	private final ImageWriter imageWriter = new ImageWriter("threads3-adaptive-rays9", 600, 600);
	...
	/** Image of Xylophonoe using Multi Threading and Adaptive Super Sampling */
    @Test
    public void xylophone() {
    	scene.geometries.add( 
                ...
                new Cylinder(new Ray(new Point(-350,280,-10), new Vector(0, 0, -1)), 15d, 120).setEmission(new Color(53, 47, 70))
                        .setMaterial(new Material().setKd(0.4).setKs(0.25).setShininess(30)),
                new Cylinder(new Ray(new Point(-350,-306,-10), new Vector(0, 0, -1)), 15d, 120).setEmission(new Color(53, 47, 70))
                        .setMaterial(new Material().setKd(0.4).setKs(0.25).setShininess(30)),
                new Cylinder(new Ray(new Point(410,-306,-10), new Vector(0, 0, -1)), 15d, 120).setEmission(new Color(53, 47, 70))
                        .setMaterial(new Material().setKd(0.4).setKs(0.25).setShininess(30)),
                new Cylinder(new Ray(new Point(410,280,-10), new Vector(0, 0, -1)), 15d, 120).setEmission(new Color(53, 47, 70))
                        .setMaterial(new Material().setKd(0.4).setKs(0.25).setShininess(30)),
                new Cylinder(new Ray(new Point(-100, 123, 100), new Vector(1, 0, 0)), 7d, 185).setEmission(new Color(BLACK))
                        .setMaterial(new Material().setKd(0.4).setKs(0.25).setShininess(30)),
                new Cylinder(new Ray(new Point(-180, -77, 100), new Vector(1, 0, 0)), 7d, 180).setEmission(new Color(BLACK))
                        .setMaterial(new Material().setKd(0.4).setKs(0.25).setShininess(30)),
                ...
                new Cylinder(new Ray(new Point(350, -200, 10), new Vector(-0.77, -2.53, 0)), 7d, 185).setEmission(new Color(BLACK))
                        .setMaterial(new Material().setKd(0.4).setKs(0.25).setShininess(30)),
                new Cylinder(new Ray(new Point(260,-220,10), new Vector(-0.51, -2.39, 0)), 7d, 185).setEmission(new Color(BLACK))
                        .setMaterial(new Material().setKd(0.4).setKs(0.25).setShininess(30)),
