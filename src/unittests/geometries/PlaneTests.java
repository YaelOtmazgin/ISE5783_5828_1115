...
class PlaneTests {
    ...
    public void testfindGeoIntersections() {
        ...
        // TC01: Ray intersects the plane but the distance from the ray head to the point is bigger than maxDistance
    	Ray myRay = new Ray(new Point(4, 3, 0), new Vector(-5.75, 3.57, 0)); // the ray isn't orthogonal or parallel to the plane and intersects the plane
    	assertNull(myPlane.findGeoIntersections(myRay, 1), "Ray end before the plane ");
    }
}
